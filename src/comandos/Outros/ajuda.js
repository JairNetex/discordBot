...
run: async (client, message, args) => {
    ...
    message.channel.send(`E aí, <@${message.author.id}>! Mandei os comandos no seu privado =). Caso não chegou, verifique se eu posso te mandar mensagens!`).then(m => m.delete({timeout: 5000})).catch((err) => console.log("NAO CONSEGUI DELETAR UMA MENSAGEM POIS A MESMA JA FOI APAGADA!"));
